...
public class HelloServiceTThreadSelectorServerV2 {
    ...
    public void startServer() {
        ...
        try {
            ...
            Hello.AsyncProcessor<Hello.AsyncIface> tProcessor = new Hello.AsyncProcessor<>(new HelloAsyncImpl());
//            TProcessor tProcessor = new Hello.Processor<Hello.Iface>(new HelloImpl());
    ...
    public static void main(String[] args) {
        HelloServiceTThreadSelectorServerV2 serviceThreadPoolServer = new HelloServiceTThreadSelectorServerV2();
