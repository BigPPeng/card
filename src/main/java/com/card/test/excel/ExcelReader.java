...
public class ExcelReader {
    ...
    private static ExcelModel convertRowToData(Row row) {
        ...
        resultData.setActivity_id(name);
        // 获取年龄
        cell = row.getCell(cellNum++);
        String ageStr = convertCellValueToString(cell);
        resultData.setActivity_code(ageStr);
        // 获取居住地
        cell = row.getCell(cellNum++);
        String location = convertCellValueToString(cell);
        resultData.setActivity_name(location);
        // 获取职业
        cell = row.getCell(cellNum++);
        String job = convertCellValueToString(cell);
        resultData.setActivity_endtime(job);

        cell = row.getCell(cellNum++);
        String leftValue = convertCellValueToString(cell);
        resultData.setLeft_value(leftValue);

        cell = row.getCell(cellNum++);
        String rightValue = convertCellValueToString(cell);
        resultData.setRight_value(rightValue);

        cell = row.getCell(cellNum++);
        String leftValue1 = convertCellValueToString(cell);
        resultData.setLeft_value1(leftValue1);

        cell = row.getCell(cellNum);
        String rightValue1= convertCellValueToString(cell);
        resultData.setRight_value1(rightValue1);
